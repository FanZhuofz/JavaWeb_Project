...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        <h2 class="form-signin-heading">Dawn日记本</h2>
...
<p align="center" style="padding-top: 15px;">版权所有  Dawn  &nbsp; Email：fans@e-team.cn  <a href="http://www.dawnfan.xyz" target="_blank">http://www.dawnfan.xyz</a></p>
      </form>
</div>
</body>
</html>